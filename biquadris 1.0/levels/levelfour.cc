...
#include "../blocks/penaltyblock.h"
#include "../block.h"
#include <cstdlib>
#include <string>

using namespace std;
// note: all blocks in level four are "heavy"
unique_ptr<Block> LevelFour::blockGenerator()
{
...
unique_ptr<Block> LevelFour::penalty()
{
    return make_unique<PenaltyBlock>();
}